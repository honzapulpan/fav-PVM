...
\end{table}
	...
	\begin{figure}[H]
		...
		\label{fig:zadani}
	\end{figure}
Prvním krokem je definice sítě na které budeme úlohu řešit. Úloha je v 2D, ale OpenFOAM řeší vše ve 3D. Třetí souřadnici tedy nastavíme minimální, jen jako jednu buňku, a budeme ji ve výsledcích vlastně ignorovat.  Nejvíce se toho bude dít kolem \uv{vykousnuté} části a proto v těchto místech síť nastavíme hustší, jak je vidět na obrázku \ref{fig:pvmesh-detail}. Celá síť je pak na obrázku \ref{fig:pvmesh} a obsahuje celkem $108 800$ jednotlivých buněk. Konkrétní definice sítě je v souboru \texttt{blockMeshDict}\linebreak v příloze \ref{app:blockmeshdict}.
\begin{figure}[H]
	\centering
...
%		--- & GS &   --- & GS &0.9&500+&1011.42\\
%		--- & GS &  --- & GS &0.3&500+&951.71\\
%		--- & GS &   --- & GS &0.95&500+&1086.7\\
%		--- & GS &  --- & GS &0.98&500+&1222.24\\
...
\addcontentsline{toc}{chapter}{Literatura}	
	\bibitem{knizka} Fadl Moukalled, Luca Mangani, Marwan Darwish:
	...
	\bibitem{openfoam}OpenFOAM Foundation:
